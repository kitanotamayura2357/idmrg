...
print(np.array(range(int(L/2)) + range(int(L/2)[::-1])
...
for step in range(N):
    ...
    H_mpo = [init_ising_H_mpo(g,x[2*step]*J,2),init_ising_H_mpo(g,x[step+1]*J,2)]
...
print("log scale",np.log(np.abs(e0-e0_exact)))
# A1B2A1B 
